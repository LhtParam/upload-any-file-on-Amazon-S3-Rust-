...
// -- constants (AWS Keys) 
const ENV_CRED_KEY_ID: &str = "AKIAXHTWDJQE3D66RLPW";
const ENV_CRED_KEY_SECRET: &str = "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";
const BUCKET_NAME: &str = "rust45";
...
async fn main() -> Result<()> {
    ...
    // Upload file
	// let path = Path::new("Paramjeet(1).png");
